...
CREATE PROCEDURE INORDER  @M AS CHAR(5), @O AS CHAR(5),@P AS INT
AS
BEGIN
	DECLARE @I AS INT;
	DECLARE @ID AS CHAR(5);
...
AS
BEGIN
	DECLARE @QR AS INT; /* ORDERED QUANTITY*/
...
BEGIN
	...
	IF @QS >= @QR
		BEGIN
			DECLARE @OQ AS INT; /* PREVIOUS ORDER QUANTITY*/
			DECLARE @NQ AS INT; /*UPDATED ORDER QUANTITY*/
...
INORDER '10-05-2022','C0001','P0002',10;
INORDER '10-05-2022','C0002','P0002',20;

UPDATE ORDERS SET OQTY=480
WHERE OID='O0009';

INORDER 'C0003','P0002',20;
